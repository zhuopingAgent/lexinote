...
- `shared/db/sql/grammar-content.sql` expands the curriculum to 346 active learning units, 27 structured comparison sets, and 19 non-empty learning modules. `shared/db/sql/seed.sql` applies both SQL files for local setup.
